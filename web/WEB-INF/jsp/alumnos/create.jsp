<%-- 
    Document   : create
    Created on : 05-nov-2015, 13:35:06
    Author     : Weiss
--%>
                        ...
                        <s:form action="save" namespace="/base/alumnos" method="post" name="frm_captura" id="frm_captura" class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="matricula" name="matricula" placeholder="Matrícula" tabindex="2">                                       
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="nombre" class="col-lg-2 control-label">Nombre</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" tabindex="3">                                       
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="ap_paterno" class="col-lg-2 control-label">Apellido paterno</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="ap_paterno" name="ap_paterno" placeholder="Apellido paterno" tabindex="4">                                       
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="ap_materno" class="col-lg-2 control-label">Apellido materno</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="ap_materno" name="ap_materno" placeholder="Apellido materno" tabindex="5">                                       
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="fecha_nacimiento">Fecha de nacimiento:</label>
                                    <sj:datepicker name="fecha_nacimiento" id="fecha_nacimiento" label="Select a Date" displayFormat="dd/mm/yy" readonly="true" tabindex="6" size="20" maxlength="17" changeMonth="true" changeYear="true" yearRange="-100:+0"/>
                                </div>
                                <div class="form-group">
                                    <s:radio label="Sexo" name="sexo" list="#{'H':'Hombre','M':'Mujer'}" tabindex="7"/>
                                </div>
                                <div class="checkbox">
                                        <s:checkbox name="activo" id="activo" fieldValue="true" label="Activo" tabindex="8" />
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <s:submit cssClass="btn btn-primary" value="Enviar" tabindex="9"></s:submit> 
                                        </div>
                                    </div>
                                </fieldset>
                        </s:form>
