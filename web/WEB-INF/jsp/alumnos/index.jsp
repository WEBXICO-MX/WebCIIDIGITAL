<%-- 
    Document   : index
    Created on : 05-nov-2015, 13:34:59
    Author     : Weiss
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    <h1>Alumno(s)</h1>
                    <s:a action="create" namespace="/base/alumnos" cssClass="btn btn-success"><span class="glyphicon glyphicon-education"></span> Crear Alumno</s:a>
                        <hr>
                    <s:if test="alumnos.size > 0">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <s:iterator value="alumnos" status="rowstatus">
                                    <tr>
                                        ...
                                        <td>
                                            <s:if test="foto == null">
                                                <s:url id="form_upload_url" action="form_upload" namespace="/base/alumnos" var="form_upload_url"><s:param name="cve_persona" value="%{cve_persona}"></s:param></s:url>
                                        ...
                                        <td>
                                            <s:url id="show_url" action="show" namespace="/base/alumnos">
                                        ...
                                        <s:a href="%{show_url}" cssClass="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span> Show </s:a>
                                            ...
                                            <td>
                                            <s:url id="delete_url" action="delete" namespace="/base/alumnos">
                                                <s:param name="cve_persona" value="%{cve_persona}"></s:param>
                                            </s:url>
